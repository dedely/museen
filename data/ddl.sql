...
CREATE TABLE location (
    loc_id CHAR(8),
    loc_room_id VARCHAR(30) NOT NULL,
...
CREATE TABLE location_history (
    ...
    location_id CHAR(8),
    location_time_in TIMESTAMP NOT NULL,
    location_time_out TIMESTAMP,
    CONSTRAINT location_history_pk PRIMARY KEY (location_visitor_id, location_id),
